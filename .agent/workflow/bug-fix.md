---
description: Sistematik bug fix protokolü - Regression önleme ve rollback planı
---

#  Bug Fix Workflow

> **⚡ WORKFLOW AKTIF:** `/bug-fix` workflow'u çalışıyor.  
> **Amaç**: Sistematik hata çözme, regression önleme, rollback stratejisi  
